...
// Using let
let name = "Kenneth Asas"; // Define a string here, e.g., "Juan Cruz"
let age = 21; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["eating", "music", "movies"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using var
var city = 'Mariveles'; // Define a string here, e.g., "New York"
